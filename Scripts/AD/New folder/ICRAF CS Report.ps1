...
$accountPasswordsToExpire | Export-Csv -Path 'C:\Users\lkavoo\Documents\Auto Reports\Report Results\ICRAF CS Reports\Accounts With Password About To Expire.csv' -NoTypeInformation
$ICRAFExpiredAccounts | Export-Csv -Path 'C:\Users\lkavoo\Documents\Auto Reports\Report Results\ICRAF CS Reports\Expired Accounts.csv' -NoTypeInformation
$ICRAFNonExpiringAccounts | Export-Csv -Path 'C:\Users\lkavoo\Documents\Auto Reports\Report Results\ICRAF CS Reports\Accounts Set Not To Expire.csv' -NoTypeInformation
$ICRAFAccounts_PasswordsNeverExpire | Export-Csv -Path 'C:\Users\lkavoo\Documents\Auto Reports\Report Results\ICRAF CS Reports\Accounts With Never Expiring Passwords.csv' -NoTypeInformation
$ICRAFAccountsAboutToExpire | Export-Csv -Path 'C:\Users\lkavoo\Documents\Auto Reports\Report Results\ICRAF CS Reports\Accounts About To Expire.csv' -NoTypeInformation
...
$ICRAFReportRecipient = @('l.kavoo@cifor-icraf.org','s.gachigi@cifor-icraf.org','g.wagana@cifor-icraf.org','c.mwangi@cifor-icraf.org')
$attachments = @('C:\Users\lkavoo\Documents\Auto Reports\Report Results\ICRAF CS Reports\Accounts About To Expire.csv','C:\Users\lkavoo\Documents\Auto Reports\Report Results\ICRAF CS Reports\Expired Accounts.csv', 'C:\Users\lkavoo\Documents\Auto Reports\Report Results\ICRAF CS Reports\Accounts Set Not To Expire.csv','C:\Users\lkavoo\Documents\Auto Reports\Report Results\ICRAF CS Reports\Accounts With Never Expiring Passwords.csv', 'C:\Users\lkavoo\Documents\Auto Reports\Report Results\ICRAF CS Reports\Accounts With Password About To Expire.csv')
